...
#ifdef display_data_cxx
display_data::display_data(TTree *tree) : fChain(0) 
{
...
Int_t display_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t display_data::LoadTree(Long64_t entry)
{
...
void display_data::Init(TTree *tree)
{
...
void display_data::Show(Long64_t entry)
{
...
Int_t display_data::Cut(Long64_t entry)
{
