...
#ifndef dump_tracks1_h
#define dump_tracks1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   dump_tracks1(TTree *tree=0);
   virtual ~dump_tracks1();
...
#ifdef dump_tracks1_cxx
dump_tracks1::dump_tracks1(TTree *tree) : fChain(0) 
{
...
dump_tracks1::~dump_tracks1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t dump_tracks1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dump_tracks1::LoadTree(Long64_t entry)
{
...
void dump_tracks1::Init(TTree *tree)
{
...
void dump_tracks1::Show(Long64_t entry)
{
...
Int_t dump_tracks1::Cut(Long64_t entry)
{
