...
#ifdef analysis6_cxx
analysis6::analysis6(TTree *tree) : fChain(0) 
{
...
Int_t analysis6::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis6::LoadTree(Long64_t entry)
{
...
void analysis6::Init(TTree *tree)
{
...
void analysis6::Show(Long64_t entry)
{
...
Int_t analysis6::Cut(Long64_t entry)
{
