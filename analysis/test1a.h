...
// Mon Apr  3 14:29:36 2023 by ROOT version 6.24/07
// from TTree fwd/fwd tracking tree
// found on file: analysis-tree.root
//////////////////////////////////////////////////////////
...
#ifdef test1a_cxx
test1a::test1a(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("analysis-tree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("analysis-tree.root");
      }
...
Int_t test1a::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t test1a::LoadTree(Long64_t entry)
{
...
void test1a::Show(Long64_t entry)
{
...
Int_t test1a::Cut(Long64_t entry)
{
