...
#ifdef analysis3_cxx
analysis3::analysis3(TTree *tree) : fChain(0) 
{
...
Int_t analysis3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis3::LoadTree(Long64_t entry)
{
...
void analysis3::Init(TTree *tree)
{
...
void analysis3::Show(Long64_t entry)
{
...
Int_t analysis3::Cut(Long64_t entry)
{
