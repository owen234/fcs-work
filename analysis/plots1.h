...
// Wed Apr  5 17:18:31 2023 by ROOT version 6.24/07
// from TChain fwd/
//////////////////////////////////////////////////////////
...
#ifdef plots1_cxx
plots1::plots1(TTree *tree) : fChain(0) 
{
...
////  chain->Add("../analysis-tree/analysis-tree-mb-mufilter-4a.root/fwd");
////  chain->Add("../analysis-tree/analysis-tree-mb-mufilter-4b.root/fwd");

 //   chain->Add("analysis-tree.root/fwd");
...
//    chain->Add("../analysis-tree/analysis-tree-mb-4d.root/fwd");
...
Int_t plots1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plots1::LoadTree(Long64_t entry)
{
...
void plots1::Show(Long64_t entry)
{
...
Int_t plots1::Cut(Long64_t entry)
{
