...
#ifndef analysis_data1_h
#define analysis_data1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   analysis_data1(TTree *tree=0);
   virtual ~analysis_data1();
...
#ifdef analysis_data1_cxx
analysis_data1::analysis_data1(TTree *tree) : fChain(0) 
{
...
Int_t analysis_data1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_data1::LoadTree(Long64_t entry)
{
...
void analysis_data1::Init(TTree *tree)
{
...
void analysis_data1::Show(Long64_t entry)
{
...
Int_t analysis_data1::Cut(Long64_t entry)
{
...
#endif // #ifdef analysis_data1_cxx
