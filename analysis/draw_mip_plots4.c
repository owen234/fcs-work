...
void draw_mip_plots4( const char* infile = "mip-search-hists-all.root" ) {
   ...
   TH1F* h_hcal_sum_e = get_hist( "h_hcal_sum_e" ) ;
   TH1F* h_mix_hcal_sum_e = get_hist( "h_mix_hcal_sum_e" ) ;
   ...
   TH1F* h_hcal_nhit = get_hist( "h_hcal_nhit" ) ;
   TH1F* h_mix_hcal_nhit = get_hist( "h_mix_hcal_nhit" ) ;
