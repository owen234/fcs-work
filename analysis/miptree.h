...
// Mon Aug  7 16:38:40 2023 by ROOT version 6.24/07
...
#ifdef miptree_cxx
miptree::miptree(TTree *tree) : fChain(0) 
{
...
Int_t miptree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t miptree::LoadTree(Long64_t entry)
{
...
void miptree::Show(Long64_t entry)
{
...
Int_t miptree::Cut(Long64_t entry)
{
