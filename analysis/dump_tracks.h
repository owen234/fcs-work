...
#ifndef dump_tracks_h
#define dump_tracks_h
...
#ifdef dump_tracks_cxx
dump_tracks::dump_tracks(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("../reco-50x50-mb-mufilter-2023-04-01a/pythia_*.root/fwd");
      tree = chain;
#endif // SINGLE_TREE
...
dump_tracks::~dump_tracks()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t dump_tracks::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dump_tracks::LoadTree(Long64_t entry)
{
...
void dump_tracks::Init(TTree *tree)
{
...
void dump_tracks::Show(Long64_t entry)
{
...
Int_t dump_tracks::Cut(Long64_t entry)
{
