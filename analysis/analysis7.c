...
void analysis7::load_fcs_mc_hit_energy_maps() {
...
void analysis7::load_fcs_rec_hit_energy_maps() {
...
void analysis7::Loop( bool arg_verbose, int max_events )
{
   if (fChain == 0) return;
