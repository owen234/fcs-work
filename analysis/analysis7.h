...
#ifdef analysis7_cxx
analysis7::analysis7(TTree *tree) : fChain(0) 
{
...
Int_t analysis7::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis7::LoadTree(Long64_t entry)
{
...
void analysis7::Init(TTree *tree)
{
...
void analysis7::Show(Long64_t entry)
{
...
Int_t analysis7::Cut(Long64_t entry)
{
