...
#ifndef mip_search1_h
#define mip_search1_h
...
#ifdef mip_search1_cxx
mip_search1::mip_search1(TTree *tree) : fChain(0) 
{
...
mip_search1::~mip_search1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t mip_search1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mip_search1::LoadTree(Long64_t entry)
{
...
void mip_search1::Init(TTree *tree)
{
...
void mip_search1::Show(Long64_t entry)
{
...
Int_t mip_search1::Cut(Long64_t entry)
{
