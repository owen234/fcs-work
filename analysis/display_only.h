...
#ifndef display_only_h
#define display_only_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   display_only(TTree *tree=0);
   virtual ~display_only();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( int first_event = 0 );
...
#ifdef display_only_cxx
display_only::display_only(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //chain->Add("fwdtree.root/fwd");
      //chain->Add("fwdtree-50mb-mu-2.root/fwd");
      //chain->Add("pythia_10_fwdtree.root/fwd");
      //chain->Add("../reco-50x50-mb-2023-04-01a/pythia_*_fwdtree.root");
      //chain->Add("../reco-50x50-mb-2023-04-01a/pythia_*_fwdtree.root");
      chain->Add("../reco-50x50-mb-mufilter-2023-04-01a/pythia_*_fwdtree.root");
      tree = chain;
...
Int_t display_only::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t display_only::LoadTree(Long64_t entry)
{
...
void display_only::Init(TTree *tree)
{
...
void display_only::Show(Long64_t entry)
{
...
Int_t display_only::Cut(Long64_t entry)
{
