...
#ifndef display_clusters1_h
#define display_clusters1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   display_clusters1(TTree *tree=0);
   virtual ~display_clusters1();
...
#ifdef display_clusters1_cxx
display_clusters1::display_clusters1(TTree *tree) : fChain(0) 
{
...
display_clusters1::~display_clusters1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t display_clusters1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t display_clusters1::LoadTree(Long64_t entry)
{
...
void display_clusters1::Init(TTree *tree)
{
...
Bool_t display_clusters1::Notify()
{
...
void display_clusters1::Show(Long64_t entry)
{
...
Int_t display_clusters1::Cut(Long64_t entry)
{
...
#endif // #ifdef display_clusters1_cxx
