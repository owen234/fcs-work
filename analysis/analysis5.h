...
#ifdef analysis5_cxx
analysis5::analysis5(TTree *tree) : fChain(0) 
{
...
Int_t analysis5::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis5::LoadTree(Long64_t entry)
{
...
void analysis5::Init(TTree *tree)
{
...
void analysis5::Show(Long64_t entry)
{
...
Int_t analysis5::Cut(Long64_t entry)
{
