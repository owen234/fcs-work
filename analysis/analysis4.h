...
// Sat Mar 25 13:40:03 2023 by ROOT version 6.24/07
// from TChain fwd/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   analysis4(TTree *tree=0);
   virtual ~analysis4();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop( bool use_mc = false, bool quiet=false );
...
#ifdef analysis4_cxx
analysis4::analysis4(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
    ...
    //chain->Add("fwdtree-2-fcs-muons.root/fwd");
    //chain->Add("fwdtree-10-fcs-muons.root/fwd");
    //chain->Add("fwdtree-50-fcs-muons.root/fwd");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t analysis4::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis4::LoadTree(Long64_t entry)
{
...
void analysis4::Init(TTree *tree)
{
...
void analysis4::Show(Long64_t entry)
{
...
Int_t analysis4::Cut(Long64_t entry)
{
