...
struct FwdTreeData {
    ...
    vector<float> fttMcpx, fttMcpy, fttMcpz;
    ...
    int fcs_mc_ecalN ;
    vector<float> fcs_mc_ecalX, fcs_mc_ecalY, fcs_mc_ecalZ, fcs_mc_ecalE ;
    vector<int> fcs_mc_ecalId, fcs_mc_ecalVid ;
    int fcs_mc_hcalN ;
    vector<float> fcs_mc_hcalX, fcs_mc_hcalY, fcs_mc_hcalZ, fcs_mc_hcalE ;
    vector<int> fcs_mc_hcalId, fcs_mc_hcalVid ;
    ...
    vector<int> rcTrackId, rcNumFST, rcCharge, rcNumFTT, rcNumPV, rcTrackIdT;

    // MC Tracks
    int mcN;
    vector<float> mcPt, mcEta, mcPhi;
    vector<int> mcVertexId, mcCharge, mcPid;
